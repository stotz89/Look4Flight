...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for (int iHin = 0; iHin < mRoundtrip.get(position).getmTripTo().getmTrips().size(); iHin++) {
            //Origin und DepTime werden nur beim ersten Durchgang gesetzt.

            if (iHin == 0) {
                holder.OriginView.setText(mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmCityFrom());
                holder.DepTimeView.setText(mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmDepTime());
            }

            // Diese Daten werden von dem eventuellen zweiten Flug überschrieben
            holder.DestinationView.setText(mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmCityTo());
            holder.DateView.setText(mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmDate());
            holder.ArrTimeView.setText(mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmArrTime());
            holder.StopsTo.setText(Integer.toString(iHin));
            priceTo += mRoundtrip.get(position).getmTripTo().getmTrips().get(iHin).getmPriceE();
        }


        if (mRoundtripBool) {
            for (int iRueck = 0; iRueck < mRoundtrip.get(position).getmTripBack().getmTrips().size(); iRueck++) {
                if (iRueck == 0) {
                    holder.OriginViewBack.setText(mRoundtrip.get(position).getmTripBack().getmTrips().get(iRueck).getmCityFrom());
                    holder.DepTimeViewBack.setText(mRoundtrip.get(position).getmTripBack().getmTrips().get(iRueck).getmDepTime());
                }

                holder.DestinationViewBack.setText(mRoundtrip.get(position).getmTripBack().getmTrips().get(iRueck).getmCityTo());
                holder.DateViewBack.setText(mRoundtrip.get(position).getmTripBack().getmTrips().get(iRueck).getmDate());
                holder.ArrTimeViewBack.setText(mRoundtrip.get(position).getmTripBack().getmTrips().get(iRueck).getmArrTime());
